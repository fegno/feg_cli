...
import 'package:feg_cli/src/command_runner.dart';
...
void main() {
  group('FegCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FegCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FegCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FegCliCommandRunner();
